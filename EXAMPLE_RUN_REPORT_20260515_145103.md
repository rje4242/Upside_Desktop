# Upside Example Run Report 20260515_145103
...
- Log directory: `example_run_logs/20260515_145103`
- Archive directory: `example_run_archives/20260515_145103`
- Summary JSON: `example_run_logs/20260515_145103/summary.json`
- Status: `completed`

## Archive

Archive step skipped by `--no-archive`.
...
Mem:            62Gi       4.6Gi        27Gi        93Mi        31Gi        57Gi
Swap:          2.0Gi          0B       2.0Gi
```
### Python Packages
```
...
| `example/04.HDX/outputs/REMD/EHEE_rd2_0005.run.0.up` | True | False | 123 matched | non-finite values present |
| `example/04.HDX/outputs/REMD/EHEE_rd2_0005.run.1.up` | True | False | 123 matched | non-finite values present |
| `example/04.HDX/outputs/REMD/EHEE_rd2_0005.run.10.up` | True | False | 123 matched | non-finite values present |
| `example/04.HDX/outputs/REMD/EHEE_rd2_0005.run.11.up` | True | False | 123 matched | non-finite values present |
| `example/04.HDX/outputs/REMD/EHEE_rd2_0005.run.12.up` | True | False | 123 matched | non-finite values present |
| `example/04.HDX/outputs/REMD/EHEE_rd2_0005.run.13.up` | True | False | 123 matched | non-finite values present |
| `example/04.HDX/outputs/REMD/EHEE_rd2_0005.run.14.up` | True | False | 123 matched | non-finite values present |
| `example/04.HDX/outputs/REMD/EHEE_rd2_0005.run.15.up` | True | False | 123 matched | non-finite values present |
| `example/04.HDX/outputs/REMD/EHEE_rd2_0005.run.2.up` | True | False | 123 matched | non-finite values present |
| `example/04.HDX/outputs/REMD/EHEE_rd2_0005.run.3.up` | True | False | 123 matched | non-finite values present |
| `example/04.HDX/outputs/REMD/EHEE_rd2_0005.run.4.up` | True | False | 123 matched | non-finite values present |
| `example/04.HDX/outputs/REMD/EHEE_rd2_0005.run.5.up` | True | False | 123 matched | non-finite values present |
| `example/04.HDX/outputs/REMD/EHEE_rd2_0005.run.6.up` | True | False | 123 matched | non-finite values present |
| `example/04.HDX/outputs/REMD/EHEE_rd2_0005.run.7.up` | True | False | 123 matched | non-finite values present |
| `example/04.HDX/outputs/REMD/EHEE_rd2_0005.run.8.up` | True | False | 123 matched | non-finite values present |
| `example/04.HDX/outputs/REMD/EHEE_rd2_0005.run.9.up` | True | False | 123 matched | non-finite values present |
